...
/**
 * Servlet implementation class MyEssentialInfoServlet
 */
@WebServlet("/MyEssentialInfoServlet")
public class MyEssentialInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MyEssentialInfoServlet() {
		super();
