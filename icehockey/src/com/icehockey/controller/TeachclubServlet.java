...
/**
 * Servlet implementation class TeachclubServlet
 */
@WebServlet("/TeachclubServlet")
public class TeachclubServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TeachclubServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		if (user != null) {// 插入成功
			...
			List<ClubRecord> clubRecords = ClubRecordService
					.queryClubRecordByUserId(userId);
			if (clubRecords != null) {
